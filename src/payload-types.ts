...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'about' | 'holoGrid';
    ...
    socialLinks?:
      | {
          platform: 'linkedin' | 'twitter' | 'instagram' | 'youtube' | 'email' | 'github';
          url: string;
          label: string;
          id?: string | null;
        }[]
  ...
  layout: (
    ...
    | {
        ...
        features: {
          title: string;
          icon: 'Terminal' | 'Bot' | 'Brain' | 'Sparkles';
          content: string;
          id?: string | null;
        }[];
        id?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "IconDemoBlock_select".
 */
export interface IconDemoBlockSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  icons?:
    | T
